    "bear":   {"codes": set(BEAR_GIFT_CODES),   "min": 20_000_000,  "max": 40_000_000,  "weight": 0.35, "name": "خرس"},
    "ice":    {"codes": set(ICE_GIFT_CODES),    "min": 15_000_000,  "max": 30_000_000,  "weight": 1.0,  "name": "بستنی"},
    "pepe":   {"codes": set(PEPE_GIFT_CODES),   "min": 150_000_000, "max": 200_000_000, "weight": 0.15, "name": "PE PE"},
    "figure": {"codes": set(FIGURE_GIFT_CODES), "min": 50_000_000,  "max": 100_000_000, "weight": 1.0,  "name": "Figure"},
}

def _gift_type(gift_code):
    try: code=int(gift_code)
    except Exception: return None
    for typ,cfg in GIFT_TYPES.items():
        if code in cfg["codes"]: return typ
    return None

def _gift_price_range(gift_code):
    typ=_gift_type(gift_code)
    if typ: return GIFT_TYPES[typ]["min"], GIFT_TYPES[typ]["max"]
...
def _gift_free():
    try:
        rows=supabase.table("premium_gifts").select("*").is_("owner_id","null").execute().data or []
        rows=[r for r in rows if _gift_type(r.get("gift_code"))]
        if not rows:return None
        weights=[GIFT_TYPES[_gift_type(r["gift_code"])]["weight"] for r in rows]
        return random.choices(rows,weights=weights,k=1)[0]
    except Exception as e:
        logging.error(f"خطا در _gift_free: {e}");return None

def gift_box_text(uid):
    return f"{_gift_emoji(5927029738626359516)} گیفت شانسی\n\n{_gift_emoji(5829923384217050622)} با خرید گیفت باکس برای خود یا دوستان میویی، شانست را برای به دست آوردن یک عدد گیفت امتحان کن\n\n{_gift_emoji(5823445637231814311)} قیمت گیفت باکس شانسی : {GIFT_BOX_PRICE:,}\n{_gift_emoji(5825623013852192219)} الماس هات : {get_balance(uid):,}\n\n{_gift_emoji(5818716826699307883)} جهت خرید گیفت باکس از گزینه‌های زیر استفاده کن"
...
def _gift_total_for_type(gift_code):
    return {
        "dog": 25,
        "snake": 30,
        "bear": 25,
...
def _gift_buy(uid):
    ...
    row=_gift_free()
    if not row:return False,"❌ فعلاً هیچ گیفتی باقی نمانده است."
    if row.get("gift_id") is None or row.get("gift_code") is None:
        logging.error(f"ردیف نامعتبر premium_gifts: instance_id={row.get('instance_id')}")
        return False,"❌ این نسخه گیفت معتبر نیست، لطفاً دوباره امتحان کن."
    gid=int(row["gift_id"]);code=int(row["gift_code"])
    value=int(row.get("current_value") or 0)
    if value<=0:value=_random_gift_price(code)
    try:
        if update_diamonds(uid,-GIFT_BOX_PRICE) is None:return False,"❌ کسر مبلغ انجام نشد."
        up=supabase.table("premium_gifts").update({"owner_id":int(uid),"current_value":value,"base_value":value,"acquired_price":value,"active":False,"acquired_at":datetime.now(TEHRAN_TZ).isoformat()}).eq("instance_id",row["instance_id"]).is_("owner_id","null").execute()
        if not up.data:
            update_diamonds(uid,GIFT_BOX_PRICE);return False,"❌ گیفت همزمان توسط فرد دیگری گرفته شد."
        return True,up.data[0]
    except Exception as e:
        update_diamonds(uid,GIFT_BOX_PRICE);logging.error("gift buy: %s",e);return False,"❌ باز کردن گیفت ناموفق بود."
...
def gifts_text(uid):
    ...
    if not gs:return "🎁 هنوز هیچ گیفتی نداری."
    return "🎁 گیفت‌های شما\n\n"+"\n".join(f"{i}. {_gift_emoji(g['gift_code'],'✨')} | آیدی: {_safe_gift_id(g):,} | ارزش: {int(g['current_value']):,} 💎"+(" ✅ فعال" if g.get('active') else "") for i,g in enumerate(gs,1))
...
def text_gift_box(message):
    ...
    m=types.InlineKeyboardMarkup();m.row(colored_button("خرید گیفت باکس 🎁",callback_data=f"giftbuy|{uid}"));m.row(colored_button("🎁 گیفت‌های من",callback_data=f"giftmine|{uid}"));show_or_edit_panel(message,uid,"giftbox",gift_box_text(uid),m,parse_mode="HTML")
...
def gift_buy_callback(call):
    ...
    ok,g=_gift_buy(uid)
    if not ok:bot.answer_callback_query(call.id,g,show_alert=True);return
    bot.answer_callback_query(call.id,"گیفت با موفقیت باز شد 🎁")
    owned_count = count_owned_by_code(uid, g['gift_code'])
    safe_send_message(uid,f"{_gift_emoji(5818785846823755322)} شما با موفقیت گیفت باکس خود را باز کردید\n\n{_gift_emoji(5929398662198206659)} گیفت جدید {_gift_emoji(g['gift_code'],'✨')}\n\n┘─ {_gift_emoji(5819046718842347822,'✨')} آیدی گیفت : {int(g['gift_id']):,}\n┘─ {_gift_emoji(5823592920250327036,'💎')} ارزش گیفت : {int(g['current_value']):,} 💎\n\n{_gift_emoji(5818677197036069696)} شما تعداد {owned_count} از این گیفت دارید\n{_gift_emoji(5830099997567229636)} درکل تعداد {_gift_total_for_type(g["gift_code"])} از این نوع گیفت وجود دارد",parse_mode="HTML")
    safe_edit_message("✅ گیفت باز شد! 📩 پیوی خودت رو چک کن.",call.message.chat.id,call.message.message_id)
...
def gift_mine_callback(call):
    ...
    try:
        ...
        for g in gs[:50]:
            m.row(colored_button(f"{_safe_gift_id(g):,} | {int(g['current_value']):,} 💎",callback_data=f"giftshow|{g['instance_id']}|{uid}",icon_custom_emoji_id=g['gift_code']))
        m.row(colored_button("🏠 منوی اصلی",callback_data=f"mainmenu|{uid}"))
        ...
        bot.answer_callback_query(call.id,"❌ خطا در نمایش گیفت‌ها. بعداً دوباره امتحان کن.",show_alert=True)
...
def gift_show_callback(call):
    ...
    try:
        ...
        if not gs:bot.answer_callback_query(call.id,"گیفت پیدا نشد.",show_alert=True);return
        ...
        bot.answer_callback_query(call.id,"❌ خطا در نمایش گیفت. بعداً دوباره امتحان کن.",show_alert=True)

@bot.callback_query_handler(func=lambda c:c.data.startswith("giftactive|"))
def gift_active_callback(call):
    uid=check_panel_owner(call)
    if uid is None:return
    ok,r=set_active_gift(uid,int(call.data.split("|")[1]));bot.answer_callback_query(call.id,"گیفت کنار اسمت فعال شد ✨" if ok else r,show_alert=not ok)

@bot.callback_query_handler(func=lambda c:c.data.startswith("giftsell|"))
def gift_sell_callback(call):
    uid=check_panel_owner(call)
    if uid is None:return
    ok,r=sell_gift(uid,int(call.data.split("|")[1]));bot.answer_callback_query(call.id,f"گیفت به {r:,} 💎 فروخته شد." if ok else r,show_alert=not ok);safe_edit_message(gifts_text(uid),call.message.chat.id,call.message.message_id,reply_markup=None,parse_mode="HTML")
...
def account_menu_markup(user_id):
    ...
    markup.row(colored_button("🎁 گیفت‌های من", callback_data=f"giftmine|{user_id}"))
...
def help_main_markup(user_id):
    ...
    markup.row(colored_button("🎁 گیفت", callback_data=f"help_topic|{user_id}|gift"))
    markup.row(
...
HELP_TOPIC_TEXTS = {
    "gift": "🎁 گیفت شانسی:\nکلمه «گیفت» را در گروه ارسال کنید. گیفت‌ها قابل فروش، انتقال و نمایش کنار اسم هستند.",
    "balance": "💰 موجودی:\nکلمه «موجودی» را در چت ارسال کنید.",
...
def resolve_bet(bet_id, opponent_id, opponent_name, is_bot=False):
    ...
    winner_display = display_name_with_tag(winner_id, winner_name or "کاربر")
    loser_display = display_name_with_tag(loser_id, loser_name or "کاربر")
    text = (
        f"◈ ━━━━━ 𝗕𝗲𝘁 ━━━━━━ ◈\n"
        f"⎙ نتیجه باز‌ی ⎙\n\n"
...
def dynamite_pending_text(amount, creator_id, creator_name):
    return (
        ...
        "☻ | بازی : دینامیت 💣\n\n"
        f"$ | مقدار الماس : {amount:,}\n"
        f"♛ | سازنده: {display_name_with_tag(creator_id, creator_name)}\n"
        "◈ ━━━━ 𝗗𝘆𝗻𝗮𝗺𝗶𝘁𝗲 ━━━━━ ◈"
    )
...
def dynamite_active_text(game):
    creator_display = display_name_with_tag(game["creator_id"], game["creator_name"])
    opponent_display = display_name_with_tag(game["opponent_id"], game["opponent_name"])
    turn_name = creator_display if game["turn_id"] == game["creator_id"] else opponent_display
    return (
        "◈ ━━━━ 𝗗𝘆𝗻𝗮𝗺𝗶𝘁𝗲 ━━━━━ ◈\n"
        "☻ | بازی : دینامیت 💣\n\n"
        f"$ | مقدار الماس : {game['amount']:,}\n"
        f"♛ | سازنده : {creator_display}\n"
        f"♔ | شرکت کننده : {opponent_display}\n\n"
        f"⎋ | نوبت: {turn_name}\n"
...
def _dynamite_finish(message_id, game, winner_id, winner_name, loser_id, loser_name, middle_text):
    ...
    text = (
        ...
        " نتیجه باز‌ی ⎙\n\n"
        f"{middle_text}\n\n"
        f"♧ | برنده: {display_name_with_tag(winner_id, winner_name)}\n"
        f"⌫ |  بازنده: {display_name_with_tag(loser_id, loser_name)}\n"
        "◈ ━━━━ 𝗗𝘆𝗻𝗮𝗺𝗶𝘁𝗲 ━━━━━ ◈"
    )
...
def _dynamite_cell_reveal_locked(call):
    ...
    if idx == game["bomb_index"]:
        ...
        if clicker_id == game["creator_id"]:
            ...
            loser_name, winner_id, winner_name = game["opponent_name"], game["creator_id"], game["creator_name"]
        middle_text = f"بازیکن {display_name_with_tag(loser_id, loser_name)} منفجر شد!"
